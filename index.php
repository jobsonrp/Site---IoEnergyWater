...
<div class="iew-main" style="margin-left:300px"> -->
  ...
  <div class="iew-container iew-padding-large" style="margin-bottom:16px"></br>
    <h3 style="color:yellow;"><b>Overview</b></h3>

<h4 style="color:white;"><b>
<p>IoEnergyWater has the main objective of improving energy performance and
Of the water consumed in a house, thereby avoiding waste. The user of the system will have full control over the electrical appliances and all water sources (faucets, showers, etc.) of the house, being able to monitor their individual consumption, make daily, monthly, weekly reports or personalized reports. The user can also get a forecast of the monthly expenses and if the energy stored in the batteries is above what is expected to spend the rest of the day he can sell his energy to the distributor.</p></h4>

<img src="/images/soa_iew.png" alt="SOA" style="width:50%;height:50%;">

<h4 style="color:white;"><b>Applicability</h4>

<h4 style="color:white;"><b>IoEnergyWater could be used in the beginning by middle-class families in about 2025, because the investment today is still high, and since "technology is democratic," the system will soon be able to bring its benefits also to the lower income classes.
Obviously, large industries will also be able to take advantage of IoEnergyWater. The investment will be refunded in a short time of use. The detail is that with the high consumption of some factories, every system should be expanded, such as the capacity of the batteries, the power generated by the solar panels, the reliability of the sensors, that is, every system would need to be improved.</p>
</b></h4>
